...
def main(msg: func.ServiceBusMessage):
    ...
    try:
        ...
        #     Mail('{}, {}, {}'.format({'john@doe.com'}, {attendee[2]}, {rows}))
        ...
        cur.execute("UPDATE notification SET status = '{}', completed_date = '{}' WHERE id = {};".format(notify_attendees, datetime.utcnow(), notification_id))
        db.commit()
