...
class BaseConfig:
    ...
    POSTGRES_DB = "techconf1"   #TODO: Update value
    ...
    ADMIN_EMAIL_ADDRESS: 'em7272@techconf1.com'
    SENDGRID_API_KEY = 'oSueuMzOQsmWxk34GXY1rw' #Configuration not required, required SendGrid Account
